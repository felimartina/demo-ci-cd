...
resource "aws_codepipeline" "demo-ci-cd" {
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ProjectName = "${aws_codebuild_project.demo-ci-cd.name}"
      }
    }
  }
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ApplicationName     = "${aws_codedeploy_app.demo-ci-cd.name}"
        DeploymentGroupName = "${aws_codedeploy_deployment_group.demo-ci-cd.deployment_group_name}"
      }
    }
  }
}